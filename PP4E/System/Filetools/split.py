"""
################################################################################ 
разрезает файл на несколько частей; сценарий join.py объединяет эти части в один 
файл; 
данный сценарий является настраиваемой версией стандартной команды split в Unix; 
поскольку сценарий написан на языке Python, он с тем же успехом может 
